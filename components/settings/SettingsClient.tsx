    ...
    <div className="space-y-8">
      ...
      <div className="transition-all duration-200">
        {activeTab === "security" ? (
          ...
          <div className="max-w-xl bg-white border border-[#EEEEEE] rounded-[10px] shadow-sm p-8 space-y-6">
          ...
          /* Audit Logs Panel */
          <div className="bg-white border border-[#EEEEEE] rounded-[10px] shadow-sm flex flex-col h-[520px] max-w-4xl">
            {/* Header */}
